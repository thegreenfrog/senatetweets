...
CREATE TABLE IF NOT EXISTS `tweets` (
  ...
  `retweets` int(20) NOT NULL,
  `hashtags` varchar(160) NOT NULL,
  `mentions` varchar(160) NOT NULL,
  `links` varchar(160) NOT NULL,
  `total_tweets` int(20) NOT NULL,
  `followers` int(20) NOT NULL,
  `following` int(20) NOT NULL,
  `is_retweeted` tinyint(1) NOT NULL,
